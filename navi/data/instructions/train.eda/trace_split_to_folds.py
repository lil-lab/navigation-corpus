...
if __name__ == '__main__':
    sentences = TraceSingleSentenceDataset.parse(open('corpus1-instructions.xgoal.noimplicit.segmented.train.eda.ccg').read())
    folds = 4
    outs = []
    for n in range(folds):
        outs.append(open('corpus1-instructions.xgoal.noimplicit.segmented.train.eda.%d.ccg' % (n), 'w'))
