...
from tracesinglesentence import *


if __name__ == '__main__':
    sentences = TraceSingleSentenceDataset.parse(open('corpus1-instructions.xgoal.noimplicit.segmented.train.wlh.ccg').read())
    folds = 4
    outs = []
    for n in range(folds):
        outs.append(open('corpus1-instructions.xgoal.noimplicit.segmented.train.wlh.%d.ccg' % (n), 'w'))
